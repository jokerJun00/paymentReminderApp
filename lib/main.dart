  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/budgets': (context) => BlocProvider.value(
              value: _authCubit,
        ...
        '/payments': (context) => BlocProvider.value(
              value: _authCubit,
              child: const PaymentsScreen(),
            ),
        '/upcomingScreen': (context) => BlocProvider.value(
              value: _authCubit,
              child: const UpcomingScreen(),
            ),
        '/editUserProfile': (context) => BlocProvider.value(
              value: _authCubit,
              child: const EditUserProfileScreen(),
            ),
        '/addCard': (context) => BlocProvider.value(
              value: _authCubit,
              child: const AddCardScreen(),
            ),
      },
      initialRoute:
          FirebaseAuth.instance.currentUser == null ? '/splash' : '/navigation',
    );
  }
}
